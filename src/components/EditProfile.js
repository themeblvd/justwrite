...
class EditProfile extends Component {
  ...
  handleSubmit = event => {
    ...
    this.props
      ...
      .then(() => {
        ...
        this.props.addNotification('Profile saved successfully.', 'success');
      });
  };
   ...
   */
  render() {
    const { id, first_name, last_name, email, url, description, avatar } = this.props;
        ...
        <div className="wrap">
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <p className="half">
              ...
              <input id="url" type="text" name="url" value={url} onChange={this.handleChange} />
            </p>
            <p>
